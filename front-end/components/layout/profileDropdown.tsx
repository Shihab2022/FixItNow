  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center text-white bg-red-500 box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
        type="button"
      >
        Dropdown button
        <svg
